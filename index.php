...
<body>
                        ...
                        <form role="form" action="validacao.php" method="post">
                            <fieldset>
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Usuario" name="usuario" id="txUsuario" maxlength="25" autofocus/>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Senha" type="password" value="" name="senha" id="txSenha" />
                                </div>
                                <div class="checkbox">
    ...
    <script src="template/metisMenu/dist/metisMenu.min.js"></script>
